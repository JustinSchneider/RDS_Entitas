...
public partial class MetaContext {
    ...
    public MetaEntity SetLogService(Sources.Services.LoggingService.Interface.ILogService newInstance) {
        if (hasLogService) {
    ...
    public void ReplaceLogService(Sources.Services.LoggingService.Interface.ILogService newInstance) {
...
public partial class MetaEntity {
    ...
    public void AddLogService(Sources.Services.LoggingService.Interface.ILogService newInstance) {
